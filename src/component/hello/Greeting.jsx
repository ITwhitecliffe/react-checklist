...
function Greeting() {
  ...
  return (
    <div>
        ...
        <form>
            <input name='fName' onChange={updateUserName} placeholder='First Name' value={userName.fName} />
            <input name='lName' onChange={updateUserName} placeholder='Last Name' value={userName.lName} />
